...
class Fpu extends Module {
  ...
  RegisterFile.io.b_rport(1).addr := io.b_port.req.fs2
    

  when(io.b_port.req.ready & io.b_port.commit.valid){
  /* ByPass */
     ByPass1.io.i_addr_fs := io.b_port.req.fs1
     ByPass1.io.i_addr_fd2 := SDecalage.io.i_adr_des
     ByPass1.io.i_addr_fd3 := SCalcul.io.i_adr_des
     ByPass1.io.i_addr_fd4 := SEcriture.io.i_adr_des
     ByPass1.io.i_val_regfile := RegisterFile.io.b_rport(0).data
     ByPass1.io.i_val_fd4 := SEcriture.io.o_data

     ByPass2.io.i_addr_fs := io.b_port.req.fs2
     ByPass2.io.i_addr_fd2 := SDecalage.io.i_adr_des
     ByPass2.io.i_addr_fd3 := SCalcul.io.i_adr_des
     ByPass2.io.i_addr_fd4 := SEcriture.io.i_adr_des
     ByPass2.io.i_val_regfile := RegisterFile.io.b_rport(1).data
     ByPass2.io.i_val_fd4 := SEcriture.io.o_data
       
    
     /* Connection entre les étages */
     
     // lecture
     SLecture.io.i_f1 := ByPass1.io.o_bypass
     SLecture.io.i_f2 := ByPass2.io.o_bypass
